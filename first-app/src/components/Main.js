...
class Main extends React.Component{
    render(){
        return(
            <div>
            <HornedBeast title='UniWhal' image_url='http://3.bp.blogspot.com/_DBYF1AdFaHw/TE-f0cDQ24I/AAAAAAAACZg/l-FdTZ6M7z8/s1600/Unicorn_and_Narwhal_by_dinglehopper.jpg' description='Parent rhino with two babies' />
